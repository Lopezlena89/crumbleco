    ...
    <>
        <div className="w-full h-[60px] bg-white/80 flex justify-between items-center px-[6%] sm:px-[10%] fixed shadow-xl z-20  border-[rgba(0,0,0,0.1)] border-b-[0.1px]">
            <div className="flex items-center w-[90px] ">
              <VscMenu size={22} className="cursor-pointer hover:fill-[#ecb3b0] duration-300" onClick={()=>setStateMenu()}/>
              <Link href={"https://maps.app.goo.gl/ir2RCYZttSfPQq8o7"}>
                <PiMapPinLight  size={22} className="ml-3 hidden sm:block cursor-pointer hover:fill-[#ecb3b0] duration-300"  />
              </Link>
            </div>
            <div className="flex flex-col h-full  justify-center items-center overflow-hidden">
              ...
              <Link href={'/'} className="flex justify-center">
                <h1 className="font-market text-xl md:text-2xl absolute -bottom-1 hover:text-[#ecb3b0] duration-500">Crumble Co</h1>
              </Link>
            </div>
            ...
            <div className="items-center w-[90px] flex justify-end ">
                <Basket/>
                <PiWhatsappLogoThin size={22} className="mx-3 hidden sm:block cursor-pointer hover:fill-[#ecb3b0] duration-300" />
                <Link href={"https://www.instagram.com/crumbleco_"}>
                  <PiInstagramLogoThin size={22} className="ml-3 sm:ml-0 cursor-pointer hover:fill-[#ecb3b0] duration-300" />
                </Link>
            </div>
